...
import CategoryShowButton from "@/Components/CategoryShowButton/CategoryShowButton";
...
const Home = async ({ searchParams }) => {
  ...
  return (
    <div style={{ scrollbarWidth: 'none' }} className="w-full ">
      ...
      <div className="flex justify-start items-start gap-4 flex-col lg:flex-row">
        <span className="lg:hidden block  bg-white text-black font-semibold rounded-2xl w-full p-4" >
        <CategoryShowButton />
        </span>
